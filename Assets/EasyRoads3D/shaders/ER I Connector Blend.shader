...
Shader "EasyRoads3D/ER I Connector Blend"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _Threshold;
			half _MainMetallicPower3;
			half _MainMetallicPower4;
			half _MainSmoothnessPower3;
			half _MainSmoothnessPower4;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord34 = IN.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_22_0 = ( IN.ase_color.a / _Threshold );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color0 ) , ( tex2D( _Albedo, texCoord34 ) * _Color ) , temp_output_22_0);
				
				float2 texCoord41 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord35 = IN.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult24 = lerp( tex2D( _BumpMap, texCoord41 ) , tex2D( _BumpMap2, texCoord35 ) , temp_output_22_0);
				...
				float2 texCoord36 = IN.ase_texcoord9.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode25 = tex2D( _MetallicGlossMap2, texCoord36 );
				float lerpResult26 = lerp( ( tex2DNode2.r * _MainMetallicPower3 ) , ( tex2DNode25.r * _MainMetallicPower4 ) , temp_output_22_0);
				
				float lerpResult27 = lerp( ( tex2DNode2.a * _MainSmoothnessPower3 ) , ( tex2DNode25.a * _MainSmoothnessPower4 ) , temp_output_22_0);
				
				float lerpResult29 = lerp( ( tex2DNode2.g * _OcclusionStrength3 ) , ( tex2DNode25.g * _OcclusionStrength4 ) , temp_output_22_0);
				

				float3 BaseColor = lerpResult16.rgb;
				float3 Normal = lerpResult24.rgb;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = lerpResult26;
				float Smoothness = lerpResult27;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord34 = IN.ase_texcoord4.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_22_0 = ( IN.ase_color.a / _Threshold );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color0 ) , ( tex2D( _Albedo, texCoord34 ) * _Color ) , temp_output_22_0);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord34 = IN.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_22_0 = ( IN.ase_color.a / _Threshold );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color0 ) , ( tex2D( _Albedo, texCoord34 ) * _Color ) , temp_output_22_0);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord41 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord35 = IN.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float temp_output_22_0 = ( IN.ase_color.a / _Threshold );
				float4 lerpResult24 = lerp( tex2D( _BumpMap, texCoord41 ) , tex2D( _BumpMap2, texCoord35 ) , temp_output_22_0);
