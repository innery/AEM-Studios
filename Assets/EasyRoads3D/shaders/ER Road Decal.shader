// © 2024 EasyRoads3D
// This decal shader can be used on Start / End decals for smooth road transitions, or other decals like cracks, fixes, manholes. 
// Standard 3D Project Usage: Set Material Render Queue to AlphaTest 2451 
Shader "EasyRoads3D/ER Road Decal"
{
	Properties
	{
		...
		[Header(Decal)]
		[Space]
		_MainTex("Decal Albedo", 2D) = "white" {}
		_Color("Color", Color) = (1,1,1,1)
		_Metallic("Metallic (R) AO (G) Smoothness (A)", 2D) = "gray" {}
		_MainMetallicPower1("Main Metallic Power", Range(0 , 2)) = 0
		_MainSmoothnessPower1("Main Smoothness Power", Range(0 , 2)) = 1
		_OcclusionStrength1("Main Ambient Occlusion Power", Range(0 , 2)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord21 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord21 ), _BumpScale );
				...
				float Alpha = ( tex2DNode1.a * _Color.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( tex2DNode1.a * _Color.a );
